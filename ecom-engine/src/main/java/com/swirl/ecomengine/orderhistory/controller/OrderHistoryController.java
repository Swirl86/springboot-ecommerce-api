...
public class OrderHistoryController {
    ...
    @Operation(
            ...
            description = "Returns a chronological list of all status changes for the specified order. "
    ...
    public ResponseEntity<List<OrderHistoryResponse>> getOrderHistory(
        ...
        List<OrderHistoryEntry> history = historyService.getHistory(orderId);
